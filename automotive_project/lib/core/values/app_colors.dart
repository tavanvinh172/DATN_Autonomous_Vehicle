...
abstract class AppColors {
  ...
  static const Color colorPrimary = Color.fromRGBO(67, 166, 198, 1);
  static const Color colorAccent = Color.fromRGBO(67, 166, 198, 1);
  static const Color colorLightGreen = Color(0xFF00EFA7);
  static const Color colorWhite = Color(0xFFFFFFFF);
  static const Color lightGreyColor = Color(0xFFC4C4C4);
  static const Color errorColor = Color(0xFF4B0F0F);
